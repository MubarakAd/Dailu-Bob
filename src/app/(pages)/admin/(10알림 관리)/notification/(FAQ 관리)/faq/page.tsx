...
import row18Column1 from "@/data/tables/row18Column1";
import {
  Button,
  Checkbox,
  Link,
...
const Page = () => {
  ...
  const pages = Math.ceil(row18Column1.length / rowsPerPage);
  ...
  const items = React.useMemo(() => {
    ...
    setCurrentData(row18Column1.slice(start, end));
    return row18Column1.slice(start, end);
        ...
        <article className="mt-10">
          ...
          >
            <TableHeader>
              ...
              <TableColumn className="truncate max-w-[120px]">답변</TableColumn>
